...
- Intrinsic directive validation for namescopes and root-only `x:Class`, plus structured attribute-value markup extension parsing with warning-only preservation
